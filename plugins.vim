...
Plug 'AndrewRadev/sideways.vim' " A Vim plugin to move function arguments (and other delimited-by-something items) left and right.
Plug 'AtsushiSakai/julia.vim' 
Plug 'JuliaEditorSupport/julia-vim' 
Plug 'RRethy/vim-illuminate' " illuminate.vim - Vim plugin for automatically highlighting other uses of the word under the cursor
Plug 'Shougo/deol.nvim', { 'do': ':UpdateRemotePlugins' } " 📁 Dark powered shell interface for NeoVim and Vim8.
Plug 'Shougo/neco-vim', { 'for': 'vim' }
Plug 'Vimjas/vim-python-pep8-indent', {'for': 'python'}
...
Plug 'delphinus/vim-auto-cursorline' " Show / hide cursorline automatically
Plug 'deoplete-plugins/deoplete-clang'
Plug 'deoplete-plugins/deoplete-dictionary' " deoplete source for dictionary
Plug 'jahanbani/vim-gams', {'for':'gams'} " GAMS
Plug 'jeetsukumaran/vim-pythonsense' " A Vim plugin that provides text objects and motions for Python classes, methods, functions, and doc strings.
...
Plug 'kalekundert/vim-coiled-snake' " Compact, but ready to strike. 🐍 Coiled Snake is a vim plugin that provides automatic folding of python code.
...
Plug 'markonm/traces.vim' " highlights the command line patterns; incompatible with inccommand
Plug 'mechatroner/rainbow_csv' "🌈CSV - Vim plugin: Highlight columns in CSV and TSV files and run queries in SQL-like language
...
Plug 'tpope/vim-abolish' " for changing the name of variables and replacements
